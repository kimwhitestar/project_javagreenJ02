...
<head>
    ...
    <script>
    	...
    	//아이디 찾기
    	function findoutId() {
    		let url = '${ctxPath}/customCompIdFindout.cmbr';
    		window.open(url,"idFindout","width=580px,height=410px");
    	}
    	//비밀번호 찾기
    	function changePwd() {
    		let url = '${ctxPath}/customCompPwdChange.cmbr';
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="container p-3 border">
				<form name="loginForm" method="post" action="${ctxPath}/customCompLoginOk.cmbr" class="was-validated">
					...
					<div class="form-group text-center">
						...
						<button type="button" class="btn btn-info btn-sm" onclick="location.href='${ctxPath}/customCompEntry.cmbr';">회원가입</button>
					</div>
