...
<head>
	...
	//아이디 중복 체크
	function idCheck() {
		let url = '${ctxPath}/customCompLoginIdCheck.cmbr';
...
<div class="container" style="padding:30px">
  <form name="entryForm" method="post" action="${ctxPath}/customCompEntryOk.cmbr" class="was-validated" >
<%--   <form name="entryForm" method="post" action="${ctxPath}/customCompEntryOk.cmbr" class="was-validated" enctype="Multipart/form-data">
 --%>    <h2 class="text-center">기 업 고 객 회 원 가 입</h2>
    ...
    <div class="form-group text-center">
	    ...
	    <input type="button" class="btn btn-info" value="돌아가기" onclick="location.href='${ctxPath}/customCompLogin.cmbr';"/><br>
		</div>
  </form>
  <p><br/></p>
</div>
