...
<div class="container" style="padding:30px">
  <form name="updateForm" method="post" action="${ctxPath}/customPersonUpdateOk.pmbr" class="was-validated" >
<%--   <form name="updateForm" method="post" action="${ctxPath}/customPersonUpdateOk.pmbr" class="was-validated" enctype="Multipart/form-data">
 --%>
    ...
    <div class="form-group">
			...
			<input type="text" class="form-control" id="name" name="name" value="${vo.customNm}" maxlength=20 required />
    ...
    <div class="form-group">
			...
			<select id="customKindCode" name="customKindCode" class="custom-select">
				...
				<option value="2" ${ '2' == vo.customKindCd ? 'selected' : '' } >개인</option>
			</select>
		</div>
